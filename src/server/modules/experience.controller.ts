...
export class ExperienceController {
  ...
  getExperience(): Promise<ExperienceEntry[]> {
    ...
    return Promise.resolve([
      {
        id: '1',
        title: 'Getty Images – Senior Software Engineer (2020 – Present)',
        description:
      ...
      {
        id: '2',
        title: 'H&R Block Canada – Software Developer (2017 – 2020)',
        description:
      ...
      },
      {
        id: '3',
        title:
          'H&R Block Canada – User Experience Designer/Researcher – Contract (2015-2017)',
        description:
