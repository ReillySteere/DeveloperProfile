...
export class SeedExperience1703289600000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const data = [
      ...
      },
      {
        ...
        endDate: '2020-01-01',
        tags: JSON.stringify(['JavaScript', 'React', 'Node.js']),
      },
      {
        id: randomUUID(),
        ...
        company: 'H&R Block Canada',
        description:
          'Worked as one of the first designers on a new User Experience team within the organization to completely reinvent the company’s digital do-it-yourself tax software. In this capacity my work has centered around the implementation of newer features / monetization channels and developing flexible architecture to support evolving business requirements.',
        bulletPoints: JSON.stringify([
        ...
        endDate: '2017-01-01',
        tags: JSON.stringify(['UX Design', 'User Research']),
      },
    ];

    for (const item of data) {
      await queryRunner.query(
        `INSERT INTO experience (id, role, company, description, bulletPoints, startDate, endDate, tags) VALUES (?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          item.id,
          item.role,
          item.company,
