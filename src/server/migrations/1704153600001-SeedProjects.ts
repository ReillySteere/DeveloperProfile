...
export class SeedProjects1704153600001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const projects: SeedProjectData[] = [
      ...
      },
      {
        ...
        execution: [
          ...
          'Led a team of 10 developers through the initial launch of this product offering and facilitated an effective hand-off to new leads for subsequent product initiatives.',
        ],
        results: [
    ...
    for (const project of projects) {
      await queryRunner.query(
        `INSERT INTO projects (id, title, shortDescription, role, requirements, execution, results, technologies, startDate, endDate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        [
          project.id,
          project.title,
          ...
          JSON.stringify(project.execution),
